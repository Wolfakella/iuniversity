...
/**
    ...
    public static void main(String[] args) throws ProtocolException, IOException {
        /// NEED TO BE CHANGED
        String token = "598cf602700db4e2a86a781f9b2b67a8";
        String domainName = "http://university.shiva.vps-private.net";
...
/*
        ...
        /// REST CALL
*/
        String functionName = "core_user_get_users_by_id";
        String urlParameters = 
                "userids[0]=" + URLEncoder.encode("3", "UTF-8") +
                "&userids[1]=" + URLEncoder.encode("4", "UTF-8") +
                "&userids[2]=" + URLEncoder.encode("5", "UTF-8");
        
        // Send request
        String serverurl = domainName + "/webservice/rest/server.php" + "?wstoken=" + token + "&wsfunction=" + functionName;
        //String serverurl =  "http://university.shiva.vps-private.net/login/token.php?username=akella&password=Ybrjkfq1.&service=moodle_mobile_app";
        //urlParameters = "";
